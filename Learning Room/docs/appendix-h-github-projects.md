# Appendix H: GitHub Projects Deep Dive
...
See [Appendix G: GitHub Actions and Workflows](appendix-g-github-actions-workflows.md) for the foundation, and the [GitHub documentation on automating projects](https://docs.github.com/en/issues/planning-and-tracking-with-projects/automating-your-project) for advanced patterns.
