...
- [ ] Chapter 11: [VS Code & Copilot](11-vscode-copilot.md) — VS Code installed with YAML syntax highlighting enabled
- [ ] Chapter 12: [Issue Templates](12-issue-templates.md) — Basic understanding of template concepts (or read this chapter for foundation)
...
**Day 2 Amplifier:** Later in Chapter 16, you'll use `@template-builder` agent to automate template creation. Come back after Chapter 14 if you haven't completed it yet.
...
**What to do:**
1. Go to [Chapter 16, Section 7](16-issue-templates.md#7-building-an-accessibility-bug-report-template) in this curriculum
...
5. Review your PR (using skills from Chapter 15!)
