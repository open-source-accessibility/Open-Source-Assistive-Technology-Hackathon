...
All commits in the PR must have a Verified badge (see [Appendix C — Commit Signing](appendix-c-git-authentication.md)). If your commits are unverified, the PR cannot be merged until you re-commit with signing enabled.
...
**What it means:** Branch protection requires signed commits (see Appendix C).
...
- [Appendix C — Git Authentication and Commit Signing](appendix-c-git-authentication.md)
- [Appendix G — GitHub Actions Workflows](appendix-g-github-actions-workflows.md)
- [Appendix O — GitHub Security Features](appendix-o-github-security-features.md)
...
*Return to: [Resources](appendix-q-resources.md) | [Appendix O — Security Features](appendix-o-github-security-features.md)*
