...
| Day 1 agenda | [docs/02-day1-agenda.md](02-day1-agenda.md) |
...
| Day 2 agenda | [docs/10-day2-agenda.md](10-day2-agenda.md) |
| VS Code: Setup & Accessibility Basics | [docs/11-vscode-basics.md](11-vscode-basics.md) |
| VS Code: Git & Source Control | [docs/12-git-source-control.md](12-git-source-control.md) |
| VS Code: GitHub Pull Requests Extension | [docs/13-github-pull-requests-extension.md](13-github-pull-requests-extension.md) |
| VS Code: GitHub Copilot | [docs/14-github-copilot.md](14-github-copilot.md) |
| VS Code: Agent Forge | [docs/15-agent-forge.md](15-agent-forge.md) |
| Issue templates | [docs/16-issue-templates.md](16-issue-templates.md) |
| Resources (this file) | [docs/appendix-q-resources.md](appendix-q-resources.md) |
| GitHub Actions and workflows | [docs/18-github-actions-workflows.md](18-github-actions-workflows.md) |
| Accessible code review | [docs/19-accessible-code-review.md](19-accessible-code-review.md) |
...
| **Appendix C:** Git authentication | [docs/appendix-c-git-authentication.md](appendix-c-git-authentication.md) |
| **Appendix D:** GitHub Gists | [docs/appendix-d-github-gists.md](appendix-d-github-gists.md) |
| **Appendix E:** Advanced GitHub features | [docs/appendix-e-advanced-github-features.md](appendix-e-advanced-github-features.md) |
| **Appendix F:** VS Code accessibility reference | [docs/appendix-f-vscode-accessibility-reference.md](appendix-f-vscode-accessibility-reference.md) |
| **Appendix G:** GitHub Actions and workflows | [docs/appendix-g-github-actions-workflows.md](appendix-g-github-actions-workflows.md) |
| **Appendix H:** GitHub Projects deep dive | [docs/appendix-h-github-projects.md](appendix-h-github-projects.md) |
| **Appendix I:** GitHub Discussions | [docs/appendix-i-github-discussions.md](appendix-i-github-discussions.md) |
| **Appendix J:** GitHub Advanced Search | [docs/appendix-j-advanced-search.md](appendix-j-advanced-search.md) |
| **Appendix K:** GitHub Releases and Tags | [docs/appendix-k-releases-tags.md](appendix-k-releases-tags.md) |
| **Appendix L:** Repository Insights | [docs/appendix-l-repository-insights.md](appendix-l-repository-insights.md) |
| **Appendix N:** GitHub Flavored Markdown | [docs/appendix-n-github-flavored-markdown.md](appendix-n-github-flavored-markdown.md) |
| **Appendix O:** GitHub Security Features | [docs/appendix-o-github-security-features.md](appendix-o-github-security-features.md) |
| **Appendix P:** Branch Protection and Rulesets | [docs/appendix-p-branch-protection-rulesets.md](appendix-p-branch-protection-rulesets.md) |
| **Appendix Q:** Resources (this file) | [docs/appendix-q-resources.md](appendix-q-resources.md) |

---

*Back: [Issue Templates](16-issue-templates.md)*
