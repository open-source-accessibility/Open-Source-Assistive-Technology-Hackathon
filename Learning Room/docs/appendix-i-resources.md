...
Interactive, self-paced courses that run entirely in GitHub. Each course uses the template-copy pattern: copy the course repo to your account, and Mona (GitHub's bot) prepares your lessons and gives feedback through issues and PRs.
...
2. Activate "Start course" — this copies the repository to your account
3. Navigate to your copy's Issues tab — Mona has created your first lesson
4. Follow the instructions in the issue, make changes, and watch Mona respond

All feedback comes through GitHub issues and pull requests — the same tools you practiced in this workshop.
...
| Resources (this file) | [docs/appendix-i-resources.md](appendix-i-resources.md) |
...
| **Appendix I:** Resources (this file) | [docs/appendix-i-resources.md](appendix-i-resources.md) |
